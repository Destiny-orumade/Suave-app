       ...
       <section className="w-full bg-white py-20 px-6 md:px-20">
            <div className="max-w-3xl mx-auto text-center space-y-20">
             ...
             <div>
                ...
                to be the foremost go-to platform for discovering and connecting with talented African creatives,
                and unlocking new levels of innovation in the African fashion industry.
                </p>
             </div>
                ...
                {/* Mission */}
                    <div>
                        ...
                        To create a streamlined network for our prospects to connect, collaborate and create.
                        </p>
                    </div>
            </div>
       </section>
